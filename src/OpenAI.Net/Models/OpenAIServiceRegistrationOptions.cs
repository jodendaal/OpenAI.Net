namespace OpenAI.Net.Models
{
    ...
    public class OpenAIServiceAzureRegistrationOptionsWithApiKey : AzureOpenAIConfig
    {
        public string ApiKey { get; set; }
    ...
    public class OpenAIServiceAzureRegistrationOptionsWithAccessToken : AzureOpenAIConfig
    {
