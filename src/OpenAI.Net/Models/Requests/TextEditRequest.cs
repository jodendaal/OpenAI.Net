...
namespace OpenAI.Net.Models.Requests
{
    public class TextEditRequest
    {
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-input" />
        /// </summary>
        public string Input { get; set; }

        /// <summary>
        /// The instruction that tells the model how to edit the prompt. <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-instruction" />
        /// </summary>
        [Required]
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-model" />
        /// </summary>
        [Required]
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-temperature" />
        /// </summary>
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-top_p" />
        /// </summary>
        ...
        /// <see href="https://platform.openai.com/docs/api-reference/edits/create#edits/create-n" />
        /// </summary>
