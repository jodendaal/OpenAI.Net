...
namespace OpenAI.Net.Models.Requests
{
    public class ImageGenerationRequest
    {
        ...
        /// <summary>
        /// The model to use for image generation.Defaults to dall-e-2 <br/>
        /// <a href="https://platform.openai.com/docs/api-reference/images/create#images-create-model">Learn more</a>. <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/images/create#images-create-model" />
        /// </summary>
        public string? Model { get; set; }

        /// <summary>
        /// The quality of the image that will be generated. hd creates images with finer details and greater consistency across the image. This param is only supported for dall-e-3.Defaults to standard <br/>
        /// <a href="https://platform.openai.com/docs/api-reference/images/create#images-create-quality">Learn more</a>. <br/>
        /// <see href="https://platform.openai.com/docs/api-reference/images/create#images-create-quality" />
        /// </summary>
        public string? Quality { get; set; }

        /// <summary>
        /// The style of the generated images. Must be one of vivid or natural. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes the model to produce more natural, less hyper-real looking images. This param is only supported for dall-e-3.Defaults to vivid <br/>
        /// <a href="https://platform.openai.com/docs/api-reference/images/create#images-create-style">Learn more</a>. <br/>
