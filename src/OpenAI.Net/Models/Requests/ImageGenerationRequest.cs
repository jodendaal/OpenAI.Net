...
namespace OpenAI.Net.Models.Requests
{
    public class ImageGenerationRequest
    {
        ...
        /// <see href="https://beta.openai.com/docs/api-reference/images/create#images/create-prompt" />
        /// </summary>
        [Required]
        ...
        /// Defaults to 1 <br/>
        /// <see href="https://beta.openai.com/docs/api-reference/images/create#images/create-n" />
        /// </summary>
        public int? N { get; set; }

        /// <summary>
        /// The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024. <br/>
        /// <see href="https://beta.openai.com/docs/api-reference/images/create#images/create-size" />
        /// </summary>
        ...
        /// Defaults to url <br/>
        /// <see href="https://beta.openai.com/docs/api-reference/images/create#images/create-response_format" />
        /// </summary>
        ...
        /// <see href="https://beta.openai.com/docs/api-reference/images/create#images/create-user" />
        /// </summary>
