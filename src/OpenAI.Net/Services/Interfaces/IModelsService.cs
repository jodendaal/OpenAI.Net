...
namespace OpenAI.Net.Services.Interfaces
{
    ...
    /// You can refer to the <a href="https://beta.openai.com/docs/api-reference/models"> Models</a> documentation to understand what models are available and the differences between them.
    /// </summary>
