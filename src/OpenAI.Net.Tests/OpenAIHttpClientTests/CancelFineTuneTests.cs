...
{
    internal class CancelFineTuneTests
    {
  ...
  ""updated_at"": 1614807352
        ...
        public async Task Test_CancelFineTune(bool isSuccess,HttpStatusCode responseStatusCode,string responseJson,string errorMessage)
        {
            ...
            var response = await openAIHttpClient.CancelFineTune("fineTuneId");
            ...
            Assert.That(path, Is.EqualTo("/v1/fine-tunes/fineTuneId/cancel"),"Apth is incorrect");
        }
    }
}
